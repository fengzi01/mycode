...
Query::Query()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_test_2eproto::InitDefaultsQuery();
  }
  SharedCtor();
...
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:Query)
  size_t total_size = 0;
...
Answer::Answer()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_test_2eproto::InitDefaultsAnswer();
  }
  SharedCtor();
...
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:Answer)
  size_t total_size = 0;
...
Empty::Empty()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_test_2eproto::InitDefaultsEmpty();
  }
  SharedCtor();
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::Query* Arena::Create< ::Query >(Arena* arena) {
  return Arena::CreateInternal< ::Query >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::Answer* Arena::Create< ::Answer >(Arena* arena) {
